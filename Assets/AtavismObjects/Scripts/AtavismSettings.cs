...
namespace Atavism
{
    ...
    public class AtavismSettings : MonoBehaviour
    {
        ...
        private OID playerTargetOid;
        private OID playerGuildOid;

        public void CheckGuildPvpState(OID targetOid)
        {
            if (playerGuildOid != null && targetOid != null)
            {
                AtavismGuildMember playerMember = AtavismGuild.Instance.GetGuildMemberByOid(playerGuildOid);
                AtavismGuildMember targetMember = AtavismGuild.Instance.GetGuildMemberByOid(targetOid);

                if (playerMember != null && targetMember != null && playerMember.name == targetMember.name)
                {
                    UpdatePvpState(true);
                }
                else
        ...
        public void UpdatePvpState(bool enabled)
        {
