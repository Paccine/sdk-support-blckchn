...
namespace Atavism
{
    public class Atavism3rdPersonInput : AtavismInputController
    {
        ...
        public void HandleImmediateKeys(float timeSinceLastFrame, float now)
        {
       ...
       */
        ...
        // O objeto que servirá como destino para o movimento do jogador
        [SerializeField] public Transform targetObject;

        // Velocidade de movimento do jogador
        public float moveSpeed = 5f;

        // Distância mínima para considerar que o jogador chegou ao destino
        public float stoppingDistance = 0.1f;

        // Variável para verificar se o jogador está em movimento
        private bool isMoving = false;

        // Função para mover o jogador para a posição do objeto de destino
