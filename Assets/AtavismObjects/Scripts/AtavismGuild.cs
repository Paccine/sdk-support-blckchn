...
namespace Atavism
{
    ...
    public class AtavismGuild : MonoBehaviour
    {
        ...
        /// <summary>
        /// Verifica se dois jogadores pertencem à mesma guilda.
        /// </summary>
        /// <param name="playerOneOid">O OID do primeiro jogador.</param>
        /// <param name="playerTwoOid">O OID do segundo jogador.</param>
        /// <returns>Retorna verdadeiro se ambos os jogadores pertencerem à mesma guilda, falso caso contrário.</returns>
        public bool IsSameGuild(OID playerOneOid, OID playerTwoOid)
        {
            AtavismGuildMember playerOne = GetGuildMemberByOid(playerOneOid);
            AtavismGuildMember playerTwo = GetGuildMemberByOid(playerTwoOid);
            ...
            bool isSameGuild = playerOne.name == playerTwo.name;
        ...
        public void UpdatePvpState()
        {
            ...
            NetworkAPI.SendExtensionMessage(ClientAPI.GetPlayerOid(), false, "UPDATE_PVP_STATE", props);
        }
